...
public class AssertionStep extends AbstractStep {
    ...
    public void checkIfDisplayedBenefitImages() {
        ...
        homePage.getBenefit().getBenefitIcons().forEach(element -> softAssertions.assertThat(element.isDisplayed()).isTrue());
    ...
    public void checkNumberOfItemsInLeftSection(int expectedSize) {
        ...
        homePage.getNavigationBar().getNavigationBar().forEach(element -> softAssertions.assertThat(element.isDisplayed()).isTrue());
        softAssertions.assertAll();
    }
    ...
    public void checkLogContain(List<String> expectedLog) {
        SoftAssertions softAssertions = new SoftAssertions();
        expectedLog.forEach(expLog -> softAssertions.assertThat(differentElementsPage.getLogPanel().findLogs(expLog)).isNotNull());
        softAssertions.assertAll();
    }
}
